...
class MusicPlayer {
    ...
    switchPlayerView(view) {
        ...
        const activeBtn = Array.from(this.navButtons).find(btn => btn.dataset.view === view);
        if (activeBtn) {
            activeBtn.classList.add('active');
        }
        
        if (view === 'player') {
            this.playerContent.classList.add('active');
        } else if (view === 'playlist') {
            this.playlistPanel.classList.add('active');
        } else if (view === 'lyrics') {
            this.lyricsPanel.classList.add('active');
        }
    }
}
